          ...
          <div className="relative">
            <div className="relative w-full max-w-lg mx-auto">
              ...
              <div className="relative w-96 h-96 mx-auto">
                ...
                <div className="absolute bottom-8 right-8 w-12 h-12 bg-brand-blue rounded-xl shadow-lg flex items-center justify-center transform rotate-30 hover:rotate-0 transition-transform duration-300 cursor-pointer">
                  <Download className="w-5 h-5 text-white" />
                </div>
                
                {/* Zap icon - right center */}
                <div className="absolute top-1/2 -translate-y-1/2 right-4 w-10 h-10 bg-brand-red rounded-lg shadow-lg flex items-center justify-center transform -rotate-30 hover:rotate-0 transition-transform duration-300 cursor-pointer">
